...
#Region "Pages Function"
    ...
    Public Sub Page3()
        ...
        Try
            ...
            If dr.Read() Then
                ...
                Else
                    ...
                    cSQL = "SELECT TC_STAT_DIVIDEND, TC_TP_PIONEER_CHARGE, TC_TP_CHARGEABLE, TC_TP_FOREIGN_CHARGE, TC_TP_FOREIGN_CHARGE,TC_EXEMPTIONCAL,TC_EXEMPTIONLESS" _
                            & " FROM TAX_COMPUTATION" _
                            & " WHERE [TC_REF_NO]='" & Trim(frmDownloadMainMenu.dgdDownload.SelectedRows.Item(0).Cells(1).Value) _
                            & "' AND [TC_YA]='" & Trim(frmDownloadMainMenu.dgdDownload.SelectedRows.Item(0).Cells(2).Value) & "'" _
                            & " ORDER BY [TC_BUSINESS]"
                    ...
                    If dr.Read() Then
                        ...
                        Else
                            pdfFormFields.SetField(pdfFieldFullPath + "A39", "0")
                        End If
                        If IsDBNull(dr("TC_EXEMPTIONLESS")) = False Then
            ...
            Else
                ...
                cSQL = "Select TC_TP_APP_CHARGEABLE1, TC_TP_APP_CHARGEABLE2, TC_TP_APP_CHARGEABLE3, TC_TP_APP_CHARGEABLE4, TC_TP_APP_CHARGEABLE4A, TC_TP_APP_CHARGEABLE5, TC_TP_APP_CHARGEABLE6, TC_TP_RATE1, TC_TP_RATE2, TC_TP_RATE3, TC_TP_RATE4, TC_TP_RATE4A, TC_TP_RATE5, TC_TP_RATE6,TC_TP_RATE7,TC_TP_RATE7_CHARGEABLE,TC_TP_APP_CHARGEABLE7," _
                ...
                pdfFormFields.SetField(pdfFieldFullPath + "B7_1", CDbl(dr("TC_TP_APP_CHARGEABLE7")).ToString.Replace(",", ""))
                ...
                pdfFormFields.SetField(pdfFieldFullPath + "B7_2", Replace(CDbl(dr("TC_TP_RATE7")).ToString("00"), ".", ""))
                pdfFormFields.SetField(pdfFieldFullPath + "B7_3", Replace((Convert.ToDouble(dr("TC_TP_RATE7_CHARGEABLE")).ToString("0.00")), ".", "").Replace(",", "")) '(CDbl(dr("")).ToString("0.00"), ".", "").Replace(",", ""))
        ...
        Catch ex As Exception
            MsgBox("Some important data is not fill in page 3!" & ex.Message, MsgBoxStyle.Critical, "Caution")
            pdfStamper.Close()
        End Try
    End Sub
    ...
    Public Sub Page8()
        ...
        Try
            ...
            cSQL = "SELECT PL_ADVERT, PL_TRAVEL, PL_JKDM, PL_OTHER_EXP, PL_NET_PROFIT_LOSS, PL_DISALLOWED_EXP, PL_TOT_EXP" _
                    & " FROM [PROFIT_LOSS_ACCOUNT]" _
                    & " WHERE [PL_REF_NO]='" & Trim(frmDownloadMainMenu.dgdDownload.SelectedRows.Item(0).Cells(1).Value) _
                    & "' And PL_YA ='" & Trim(frmDownloadMainMenu.dgdDownload.SelectedRows.Item(0).Cells(2).Value) & "'"
            dr = DataHandler.GetDataReader(cSQL, Conn)
    ...
    Public Sub Page10()
        ...
        Catch ex As Exception
            MsgBox("Some important data is not fill in page 10!" & ex.Message, MsgBoxStyle.Critical, "Caution")
            pdfStamper.Close()
        End Try
    End Sub
